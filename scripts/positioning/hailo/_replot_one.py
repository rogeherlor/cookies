#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Self-contained: replot one algorithm's PNG from its already-cached
trajectory npz in seq08_traj_cache/, without touching any other file or
rerunning any filter."""
import argparse
import sys
...
print(f"{args.approach} raw-ENU rmse: {rmse:.2f}m")
...
ax.set_title(args.label, fontsize=11)
ax.tick_params(labelsize=7)
ax.grid(True, alpha=0.3)
ax.legend(fontsize=7, loc="best")
fig.tight_layout()
save_path = _REPO_ROOT / "images" / "c3" / "seq08" / f"{args.approach}.png"
