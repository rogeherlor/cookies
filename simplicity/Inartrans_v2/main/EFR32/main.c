 ...
 * - SOLO_RELAY 1/0 si se utiliza solo como nodo router (0) o Sensor tambi�n (1)
 *
 ...
 *
 * Para programar la placa, hay que darle al bot�n de Flash Programmer, y seleccionar el binario de la carpeta del proyecto (.hex)
 *
 *
 */
...
#if (RED_USADA != RED_JAIME)				// para la prueba de envios de seguridad no queremos reports extra�os, simplemente el envio
#if (SOLO_RELAY != 1)
